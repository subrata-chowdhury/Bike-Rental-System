        ...
        <>
            ...
            <div className='p-4'>
                ...
                <div className='d-flex justify-content-end mt-2'>
                    {bookingData.status === 'booked' && <button className='btn btn-dark'>Pick Up</button>}
                    {bookingData.status === 'picked up' && <button className='btn btn-dark'>Request Return</button>}
